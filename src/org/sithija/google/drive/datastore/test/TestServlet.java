	...
	@Override
	  public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		Document document1 = new Document(
				"a.txt",
				new URL("https://docs.google.com/document/d/1gtNOaaDa64rLgrpD8fLmGvkzgdf9J41zhm2Y3A-ExGk/edit"),
				Calendar.getInstance().getTime(), userKey1);
		
		Document document2 = new Document(
				"b.txt",
				new URL("https://docs.google.com/document/d/1laZ2uRozlRQ72pY_RxylWIpKn3HaB6DHe6rJXAg2He8/edit"),
	    ...
	    resp.getWriter().println("user1" + user1.getEmail()+ " = "+ ProfileApi.getProfile(user1.getEmail(), WSO2.getCompanyName()).getEmail());
	    resp.getWriter().println("user2" + user2.getName()+ "="+ ProfileApi.getAllUsers().get(1).getName());
