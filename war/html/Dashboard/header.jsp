...
<link
	...
	rel="stylesheet" type="text/css" />
<!-- Morris chart -->
<link href="../html/css/morris/morris.css" rel="stylesheet"
	type="text/css" />
<!-- jvectormap -->
<link href="../html/css/jvectormap/jquery-jvectormap-1.2.2.css"
	rel="stylesheet" type="text/css" />
<!-- Date Picker -->
...
<link
	href="../html/css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css"
	rel="stylesheet" type="text/css" />
<!-- Theme style -->
...
<body class="skin-blue" onload="setSRC()">
	...
	<header class="header">
		<a href="../user/index.jsp" class="logo"> <!-- Add the class icon to your logo image or logo icon to add the margining -->
			...
			<div class="navbar-right">
				<ul class="nav navbar-nav">
								...
								<ul class="menu">
									<li>
										<!-- start message --> <a href="#">
											<div class="pull-left">
												<img src="../html/img/avatar3.png" class="img-circle"
													alt="User Image" />
											</div>
											<h4>
									...
									<li><a href="#">
											<div class="pull-left">
												<img src="../html/img/avatar2.png" class="img-circle"
													alt="user image" />
											</div>
											<h4>
									...
									<li><a href="#">
											<div class="pull-left">
												<img src="../html/img/avatar.png" class="img-circle"
													alt="user image" />
											</div>
											<h4>
					...
					<li class="dropdown user user-menu"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"> <i
							class="glyphicon glyphicon-user"></i> <span><%=user.getNickname()%>
								<i class="caret"></i></span>
					</a>
						<ul class="dropdown-menu">
							<!-- User image -->
							<li class="user-header bg-light-blue"><img id='userPhoto'
								src="../html/img/avatar.png" class="img-circle" alt="User Image" />
								<p>
									<%=user.getNickname()%>
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="/admin/adminLogin.jsp"
										class="btn btn-default btn-flat">Admin</a>
								</div>
								<div class="pull-right">
									<a
										href="<%=userService.createLogoutURL("/authentication.jsp")%>"
